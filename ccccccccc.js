...
(function() {
    ...
    function createUI() {
        ...
        if (typeof $ !== 'undefined' && $.fn && $.fn.appendTo) {
            ...
            // 没有 jQuery 时回退到原生（但潮汐用了 jQuery，酒馆里应该都有）
    ...
    // ===== 启动方式：和潮汐完全一致 =====
    // 潮汐使用 $(() => { ... }) 即 DOMContentLoaded
    // 我们使用标准的 DOMContentLoaded
